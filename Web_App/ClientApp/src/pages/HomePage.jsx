    ...
    return (
        <>
            <div class="mt-16 w-full">
                <h1 className="text-5xl font-bold text-center hover:text-primary-300 ease-in-out duration-300 cursor-default max-2xl:text-3xl">K*rwa Shop Top Zajebis</h1>
                <div class="container mx-auto w-2/3 gap-14 px-3 flex items-center mt-10 max-xl:flex-col">
                    <div class="flex flex-col w-1/2 max-xl:w-full justify-center items-start text-center md:text-left hover:scale-105 ease-in-out duration-300 cursor-default">
            ...
            <div class="w-2/3 mx-auto mt-16">
                <h2 class="w-full text-5xl max-2xl:text-3xl font-bold leading-tight text-center text-primary-300 hover:text-black ease-in-out duration-300 cursor-default">
                    Why Choose K*rwa?
                </h2>
                <div class="flex items-center max-xl:text-center max-xl:flex-col w-full gap-14 mt-10">
                    <div class="w-1/2 max-xl:w-full flex flex-col gap-6">
                        <div className="hover:scale-105 ease-in-out duration-300">
                            <h3 class="text-3xl max-2xl:text-xl w-full text-primary-300 font-bold ease-in-out duration-300 cursor-default">
                                Licensed Excellence
                            </h3>
                            <p class="text-primary-500 mt-4 max-2xl:text-base ease-in-out duration-300 cursor-default">
                        ...
                        <div className="hover:scale-105 ease-in-out duration-300">
                            <h3 class="text-3xl max-2xl:text-xl text-primary-300 font-bold ease-in-out duration-300 cursor-default">
                                Expert Guidance
                            </h3>
                            <p class="text-primary-500 mt-4 max-2xl:text-base ease-in-out duration-300 cursor-default">
            ...
            <section class="bg-primary-200 py-8 mt-16">
                <div class="container mx-auto px-2 pt-4 pb-12 text-primary-500">
                    <h2 class="w-full my-2 text-5xl max-2xl:text-3xl font-bold leading-tight text-center text-primary-400 hover:text-black ease-in-out duration-300 cursor-default">
                        Most Popular
                    </h2>
                    <div class="flex max-lg:flex-col justify-center my-10">
                        <div class="flex flex-col w-1/4 max-lg:w-5/6 mt-4 max-md:mt-0 mx-0 max-lg:mx-auto bg-white ease-in-out duration-300 cursor-default">
                            <div class="flex-1 bg-primary-100 text-primary-400 rounded-lg overflow-hidden shadow-xl max-lg:mb-10 max-lg:scale-100 max-lg:hover:scale-105 scale-105 hover:scale-110 ease-in-out duration-300">
                                <div class="p-8 text-3xl max-2xl:text-xl font-bold text-center ease-in-out duration-300 cursor-default">
                                    AK-58
                                </div>
                                <img src={shopPhoto} className="w-full h-full rounded-lg"></img>
                            </div>
                        </div>
                        <div class="flex flex-col w-1/3 max-lg:w-5/6 -mt-6 mx-0 max-lg:mx-auto mt-4 max-sm:-mt-6 shadow-lg z-10 ease-in-out duration-300 cursor-default">
                            <div class="flex-1 bg-primary-100 rounded-lg overflow-hidden shadow-xl hover:scale-105 ease-in-out duration-300 cursor-default">
                                <div class="w-full p-8 text-3xl max-2xl:text-xl font-bold text-center ease-in-out duration-300 cursor-default">
                                    AK-1777
                                </div>
                                <img src={shopPhoto} className="w-full h-full rounded-lg"></img>
                            </div>
                        </div>
                        <div class="flex flex-col w-1/4 max-lg:w-5/6 mt-4 max-md:mt-6 mx-0 max-lg:mx-auto bg-white ease-in-out duration-300 cursor-default">
                            <div class="flex-1 bg-primary-100 text-primary-400 rounded-lg overflow-hidden shadow-xl max-lg:scale-100 max-lg:hover:scale-105 scale-105 hover:scale-110 ease-in-out duration-300 cursor-default">
                                <div class="p-8 text-3xl max-2xl:text-xl font-bold text-center ease-in-out duration-300 cursor-default">
                                    AK-47
                                </div>
                                <img src={shopPhoto} className="w-full h-full rounded-lg"></img>
            ...
            <div class="container w-2/3 flex mx-auto items-center justify-center flex-wrap pt-4 pb-12 gap-6 mt-16">
                <h2 class="w-full my-2 text-5xl max-2xl:text-3xl font-bold leading-tight text-center text-gray-800 hover:text-primary-300 ease-in-out duration-300 cursor-default">
                    Mission
                </h2>
